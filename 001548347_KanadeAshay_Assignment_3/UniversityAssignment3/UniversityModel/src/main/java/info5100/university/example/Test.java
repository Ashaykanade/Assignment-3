...
public class Test {
    ...
    public static void main(String args[]){
        ...
        College college1 = new College("Khoury College Of Computer Science");
        
        university.addCollege(college);
        university.addCollege(college1);
        
        
        Department dp1 = new Department("Information System");
        Department dp2 = new Department("Engineering Management");
        Department dp3 = new Department("Computer Science");
        Department dp4 = new Department("Cyber Security");
        ...
        for(int i =0; i<20; i++){
            Person pf=pd.newPerson("Student "+String.valueOf(i+1),"first_name","last_name");
            if(i%4==0){
...
//        }
        ...
        System.out.println(dp2.getCourseSchedule("Spring2016").getCoursecatalog().getCourseList().size());
